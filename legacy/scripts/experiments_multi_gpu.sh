...
#   Multi GPUs launch
for mixed_precision in no fp16 bf16 fp8
do
                        ...
                        do
                            ...
                            do
                                ...
                                do
                                    ...
                                    (
                                        MULTIGPS_ARGS=" --main_process_port 60064 --num_processes 2"
                                        LAUNCH_ARGS="$LAUNCH_ARGS --gpu_ids 0,1"
                                    ...
                                    (
                                        MULTIGPS_ARGS=" --main_process_port 60043  --num_processes 2"
                                        LAUNCH_ARGS="$LAUNCH_ARGS --gpu_ids 2,3"
